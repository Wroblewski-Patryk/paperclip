...
const projectId = process.env.COOLIFY_SOAR_PROJECT_UUID ?? process.env.COOLIFY_SOAR_PROJECT_ID;
...
const directResourceRoutes = [
  ...
  ["COOLIFY_SOAR_WORKER_BACKTEST_APP_ID", "application", "/api/v1/applications"],
  ["COOLIFY_SOAR_WORKER_EXECUTION_APP_ID", "application", "/api/v1/applications"],
  ["COOLIFY_SOAR_WORKER_MARKET_DATA_APP_ID", "application", "/api/v1/applications"],
  ["COOLIFY_SOAR_WORKER_MARKET_STREAM_APP_ID", "application", "/api/v1/applications"],
