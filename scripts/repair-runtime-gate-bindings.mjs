...
const gateBindingPlans = {
  "LUC-241": {
    ...
    env: {
      ...
      PROD_UI_AUDIT_ADMIN_TOKEN: "prod_ui_audit_admin_token",
      PROD_UI_AUDIT_ADMIN_EMAIL: "prod_ui_audit_admin_email",
      PROD_UI_AUDIT_ADMIN_PASSWORD: "prod_ui_audit_admin_password",
      PROD_UI_AUDIT_API_BASE_URL: "prod_ui_audit_api_base_url",
      PROD_UI_AUDIT_WEB_BASE_URL: "prod_ui_audit_web_base_url",
  ...
  "LUC-261": {
    ...
    env: {
      COMPANYCORE_API_KEY: "companycore_api_key",
      COMPANYCORE_BASE_URL: "companycore_base_url",
    },
  },
  "LUC-3924": {
    agentNames: [
    ...
    env: {
      LIVEIMPORT_READBACK_API_BASE_URL: "liveimport_readback_api_base_url",
      LIVEIMPORT_READBACK_WEB_BASE_URL: "liveimport_readback_web_base_url",
      LIVEIMPORT_READBACK_EXPECTED_SHA: "liveimport_readback_expected_sha",
      LIVEIMPORT_READBACK_AUTH_TOKEN: "liveimport_readback_auth_token",
      LIVEIMPORT_READBACK_AUTH_EMAIL: "liveimport_readback_auth_email",
      LIVEIMPORT_READBACK_AUTH_PASSWORD: "liveimport_readback_auth_password",
      LIVEIMPORT_READBACK_OPS_AUTH_HEADER_NAME: "liveimport_readback_ops_auth_header_name",
      LIVEIMPORT_READBACK_OPS_AUTH_HEADER_VALUE: "liveimport_readback_ops_auth_header_value",
      LIVEIMPORT_READBACK_OPS_BASIC_USER: "liveimport_readback_ops_basic_user",
      LIVEIMPORT_READBACK_OPS_BASIC_PASSWORD: "liveimport_readback_ops_basic_password",
    },
  },
};
