...
function companyOperatingManual() {
  return [
    ...
    "- Aviary, Nest, Featherly, and other future apps remain parked until the board explicitly reopens them for V2 or a named exception.",
    "",
    "## Value Streams",
    "",
...
const decisionSpecs = [
  {
    ...
    recommended: "Use the roadmap Softwarehouse V0 local app factory (Soar + Roost) -> Softwarehouse V1 hosted Paperclip + governed Roost company plane -> Softwarehouse V2 portfolio expansion; keep Aviary, Nest, and Featherly prepared but parked until you explicitly activate them.",
    alternatives: [
