...
const specs = [
  ...
  },
  {
    ...
    description: [
      ...
      "Treat `todo` as runnable and `backlog` as reserve inventory. Each active track needs at least one runnable worker todo plus three planned worker todo/backlog lanes until its target is verified or explicitly blocked.",
