...
import { admissionControlRoutes } from "./routes/admission-control.js";
...
import { decisionCenterRoutes } from "./routes/decision-center.js";
...
export async function createApp(
  ...
  api.use(decisionCenterRoutes(db));
