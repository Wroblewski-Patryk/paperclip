...
const AgentRunCard = memo(function AgentRunCard({
  ...
  return (
    <div className={cn(
      ...
      isActive
        ? "border-[var(--company-accent-border)] bg-[var(--company-accent-subtle)] ring-1 ring-inset ring-[var(--company-accent-soft)]"
      ...
      <div className="border-b border-border/60 px-3 py-3">
        <div className="flex items-start justify-between gap-2">
          ...
          <Link
            ...
            aria-label={`Open ${run.agentName} run`}
          ...
          <div className="mt-3 rounded-lg border border-border/60 bg-background/60 px-2.5 py-2 text-xs">
            <Link
              ...
              className={cn(
                ...
                isActive ? "text-[var(--company-accent-strong)]" : "text-muted-foreground hover:text-foreground",
              )}
