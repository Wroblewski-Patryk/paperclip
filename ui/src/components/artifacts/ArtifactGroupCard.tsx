      ...
      {stacked ? (
        <>
          <div
            ...
            className="pointer-events-none absolute inset-0 translate-x-[8px] translate-y-[8px] rounded-xl border border-border bg-muted/40 shadow-sm"
          />
          <div
            aria-hidden="true"
            data-testid="artifact-stack-layer"
            className="pointer-events-none absolute inset-0 translate-x-[4px] translate-y-[4px] rounded-xl border border-border bg-muted/70 shadow-sm"
          />
        </>
      ) : null}
