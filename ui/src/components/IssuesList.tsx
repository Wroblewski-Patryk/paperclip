    ...
    <div ref={rootRef} className="space-y-4">
      ...
      {viewState.viewMode === "board" ? (
        ...
        <>
          ...
          <Collapsible
            key={group.key}
            className="paperclip-surface overflow-hidden"
                ...
                const renderIssueRow = (issue: Issue, depth: number) => {
                  ...
                  const checklistDependencyChips = checklistMeta && firstVisibleBlockerChip ? (
                    <button
                      ...
                      className="inline-flex items-center rounded-full border border-amber-400/45 bg-amber-50/60 px-1.5 py-0.5 text-[11px] font-medium text-amber-700 hover:bg-amber-100/80 dark:border-amber-300/35 dark:bg-amber-400/10 dark:text-amber-300"
                        ...
                        titleSuffix={(
                          <>
                            ...
                            {issueBadge ? (
                              issueBadge === "Paused" ? (
                                <span
                                  className={cn("ml-1.5 inline-flex items-center gap-1 rounded-full px-1.5 py-0.5 text-[11px] font-medium", statusBadge.paused)}
                                  aria-label="Paused"
                                  title="Paused"
                                >
                                ...
                                <span className="ml-1.5 inline-flex items-center rounded-full border border-amber-500/40 bg-amber-500/10 px-1.5 py-0.5 text-[11px] font-medium text-amber-700 dark:text-amber-300">
                                  {issueBadge}
                                </span>
                              )
                            ) : null}
                            {isSuccessfulRunHandoffRequired(issue) ? (
                              <span
                                className="ml-1.5 inline-flex items-center gap-1 rounded-full border border-amber-400/45 bg-amber-50/60 px-1.5 py-0.5 text-[11px] font-medium text-amber-700 dark:border-amber-300/35 dark:bg-amber-400/10 dark:text-amber-300"
