  ...
  return (
    <div className="max-w-4xl space-y-6">
      ...
      <section className="space-y-8">
        <div className="paperclip-surface relative overflow-hidden">
          ...
          <div className="relative p-6 pt-10">
            <div className="paperclip-inset flex flex-wrap items-end gap-5 bg-background/92 p-5 shadow-[0_18px_44px_-28px_rgba(0,0,0,0.45)] backdrop-blur-sm">
