...
export function JoinRequestQueue() {
  ...
  return (
    <div className="max-w-6xl space-y-6">
      ...
      <div className="paperclip-surface flex flex-wrap gap-3 p-4">
      ...
      <div className="space-y-4">
        {(requestsQuery.data ?? []).length === 0 ? (
          <div className="paperclip-empty-state px-4 py-8 text-sm text-muted-foreground">
            No join requests match the current filters.
          </div>
        ) : (
          requestsQuery.data!.map((request) => (
            <div key={request.id} className="paperclip-surface p-4">
              ...
              <div className="mt-4 grid gap-3 text-sm text-muted-foreground md:grid-cols-2">
                <div className="paperclip-inset px-3 py-2">
