...
## Operating Role
Reports to 10 CLO. Owns technical security/privacy review, abuse-case analysis, secret-handling checks, authz boundaries, and risk notes for softwarehouse work. Does not act as a legal department.
