...
| SH-QA-004 | observability | Project state changes after audit or implementation. | Commit/evidence generated. | Project docs/status/history and `/Aplikacje` root index are refreshed. | root portfolio drift audit. | medium |
