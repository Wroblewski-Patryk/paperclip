# LUC-851 Portfolio Truth And Workspace Boundary Review
...
- Allowed roots were present for `Paperclip_Softwarehouse`, `Soar`, and
  `Roost`.
- The audit reports static forbidden-root checks for
...
- The generated applications index was refreshed at
  `2026-07-13T02:43:32.519Z` and still reflects the current portfolio root and
  active Stage 1 set.
