...
| chief-human-resources-officer | 06 CHRO (Chief Human Resources Officer) | Chief Human Resources Officer | Owns agent staffing, role clarity, responsibility boundaries, unhealthy-agent follow-up, onboarding/offboarding of agent roles, and workload/WIP hygiene for the app-building company. |
| people-operations-partner | 06 POP (People Operations Partner) | People Operations Partner | Reserved CHRO report for human people-operations work: operator onboarding notes, contributor collaboration process, human review expectations, and board handoff clarity. Stays inactive unless the board opens human people-ops work; does not own AI-agent prompt, skill, routine, or adapter improvement. |
| ai-agent-development-partner | 06 AID (AI Agent Development Partner) | AI Agent Development Partner | Owns AI-agent development under CHRO: reviews recent agent work for repeated instruction, skill, routine, role, or tool gaps; applies small low-risk durable improvements; and proposes governed role/process changes with evidence and retirement conditions. |
