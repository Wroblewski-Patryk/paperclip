...
export const DEFAULT_CODEX_LOCAL_CHEAP_MODEL = "gpt-5.5";
...
export const CODEX_LOCAL_UNSUPPORTED_MODEL_REMAPS = {
  "gpt-5-mini": DEFAULT_CODEX_LOCAL_CHEAP_MODEL,
  "gpt-5.3-codex": DEFAULT_CODEX_LOCAL_MODEL,
  "gpt-5.3-codex-spark": DEFAULT_CODEX_LOCAL_MODEL,
} as const;
...
export function resolveCodexLocalModel(model: string | null | undefined): string {
  ...
  return CODEX_LOCAL_UNSUPPORTED_MODEL_REMAPS[
    normalizedModel as keyof typeof CODEX_LOCAL_UNSUPPORTED_MODEL_REMAPS
  ] ?? normalizedModel;
}
...
export const modelProfiles: AdapterModelProfileDefinition[] = [
  {
    key: "cheap",
    label: "Cheap",
    description: "Use the supported Codex local triage lane without changing the primary model.",
    adapterConfig: {
