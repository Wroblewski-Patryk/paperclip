...
export const DEFAULT_PAPERCLIP_AGENT_PROMPT_TEMPLATE = [
  ...
  "- Any transition to `done` must include a typed `completionEvidence` bundle with test, review, and documentation evidence; high-risk work also needs security, deployment, and monitoring evidence.",
