...
export const DEFAULT_PAPERCLIP_AGENT_PROMPT_TEMPLATE = [
  ...
  "- For CompanyCore knowledge, call GET /api/agents/me/knowledge before loading broad external context. Treat that response as your department-scoped knowledge inventory.",
  "- For CompanyCore tools, call GET /api/agents/me/tools before taking external company actions. Use only assigned tools; CompanyCore remains the source of truth behind Drive, ClickUp, and other synced systems.",
  "- If you need knowledge owned by another department, ask or delegate to that department's agent through Paperclip issues/comments instead of merging every department's context into your own working memory.",
