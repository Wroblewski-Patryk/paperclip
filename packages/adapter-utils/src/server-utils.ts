...
export const DEFAULT_PAPERCLIP_AGENT_PROMPT_TEMPLATE = [
  ...
  "- Every board-facing interaction should include payload.decisionContext with audience, decisionClass, decisionReady, authorityReason, recommendation, evidenceRefs, risk, urgency, and reversibility. Route technical review to the responsible agent instead of the board; never ask the board to paste a secret value—request a secret-ref alias only.",
