...
const manifest: PaperclipPluginManifestV1 = {
  ...
  apiVersion: 1,
  version: "0.2.1-luckysparrow.0",
  displayName: "Hindsight Memory",
  author: "Vectorize / LuckySparrow",
  description:
    "Persistent long-term memory for Paperclip agents. Recalls relevant issue context before each run and retains comments as durable memory.",
  ...
  instanceConfigSchema: {
    ...
    properties: {
      hindsightApiUrl: {
        ...
        description: "Base URL of your Hindsight instance. Use http://localhost:8888 for local self-hosted Hindsight.",
      ...
      bankGranularity: {
        ...
        description: "Controls memory isolation. Default ['company', 'agent'] gives each agent its own bank per company.",
