...
- For frontend/design work, verify the rendered surface in a real browser at relevant desktop/mobile viewports and compare it against the design/reference or acceptance criteria.
